...
**DISCLAIMER**: This is my first attempt at a HA custom component and it was painful. Also it still has bugs. Also the entire thing below was written by Gepeto (but it's pretty accurate).
...
1. **Enable SSH on your ASUS router:**
    ...
    *   Set **Enable SSH** to `LAN Only`. DO NOT EXPOSE IT BECAUSE IT USES SSH WITH PASSWORD.
...
2. **Configure the integration in Home Assistant:**
    ...
    *   Enter the following information:
        ...
        *   **Password:** Your router's SSH password (the same for the captive portal).
    *   Click **Submit**.
